...
The ExcelFile class contains methods to encrypt and decrypt data using AES encryption. The encrypt_data method encrypts the file content before storing it in the database, and the decrypt_data method decrypts the content retrieved from the database. 
 Make sure to replace the encryption_key with your own securely generated key. 
...
# Encryption key (change this to your secure key)
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://47ef-2603-3005-373f-c100-2c34-320a-382c-485b.ngrok-free.app:3000","*","https://10.1.10.45:3000","2601:19b:b00:26d0:98e3:e30d:1202:c711"],# "*" allow any connections from outside #"2601:44:401:e869:885a:6846:8594:f0c7:0","2601:19b:b00:26d0:98e3:e30d:1202:c711","https://76.98.75.253:3000"],  # Adjust this based on your frontend URL
    allow_credentials=True,
    allow_methods=["*"],
    allow_headers=["*"],
)
# OAuth2PasswordBearer for handling token 
...
async def upload_excel(file: UploadFile = File(...)):
    db = SessionLocal()
    try:
        # Store file in database after encryption
        content = file.file.read()
        encrypted_content = ExcelFile.encrypt_data(content, encryption_key)
        db_file = ExcelFile(file_name=file.filename, file_data=encrypted_content)
        db.add(db_file)
        db.commit()
...
### Create a seperate file for med data and call it in the @app.get("/medicines")
medicines = [
